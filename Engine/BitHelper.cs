...
namespace Engine
{
    public class BitHelper
    {
        ...
        /// <param name="val">Value for which the mask is needed.</param>
        /// <returns>The mask.</returns>
        public static UInt64 GetMostSignificant1BitMask(UInt64 val)
        {
        ...
        public static UInt64 GetMostSignificantBit(UInt64 val)
        {
        ...
        public static byte GetMostSignificant1BitIndex2(UInt64 val)
        {
            UInt64 debruijn64 = 0x03f79d71b4cb0a89;
            val |= val >> 1;
            val |= val >> 2;
