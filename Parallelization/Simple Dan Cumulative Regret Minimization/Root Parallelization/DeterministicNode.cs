...
namespace Parallelization.SRCR.Root
{
                ...
                else
                {
                    if (c is NondeterministicNode)
                    {
                        ...
                        else
                        {
                            if (c.type == NODE.MAX)
                            {
                                ucb = ((NondeterministicNode)c).selected.winRate + cs * (Math.Sqrt((Math.Sqrt(this.nVisits)) / ((NondeterministicNode)c).selected.nVisits));
                            }
                            else
                            {
                    ...
                    else
                    {
                        if (c.type == NODE.MAX)
                        {
                            ucb = c.winRate + cs * (Math.Sqrt((Math.Sqrt(this.nVisits) / c.nVisits)));
                        }
                        else
                        {
