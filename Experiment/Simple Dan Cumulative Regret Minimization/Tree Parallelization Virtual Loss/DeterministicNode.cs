...
namespace Experiment.SRCR.TreeVl
{
    public class DeterministicNode:Node
    {
        ...
        public void selectAction()
        {
            ...
            ((DeterministicNode)cur).virtualLoss += 1;
            ...
            foreach (Node c in children)
            {
                ...
                if (bestUCB <= ucb)
                {
                    ...
                    if (selected != null)
                    {
                        if (c is NondeterministicNode)
                        {
                            if (((NondeterministicNode)c).selected != null)
                            {
                                if (selected is NondeterministicNode)
                                {
                                    if (((NondeterministicNode)selected).selected != null)
                                    {
                                        if ((((DeterministicNode)((NondeterministicNode)selected).selected).virtualLoss) <= ((DeterministicNode)((NondeterministicNode)c).selected).virtualLoss)
                                        {
                                            selected = c;
                                        }
                                    }
                                ...
                                {
                                    if (((DeterministicNode)selected).virtualLoss <= ((DeterministicNode)((NondeterministicNode)c).selected).virtualLoss)
                                    {
                                        selected = c;
                                    }
                                }
                        ...
                        else
                        {
                            if (selected is NondeterministicNode)
                            {
                                if (((NondeterministicNode)selected).selected != null)
                                {
                                    if ((((DeterministicNode)((NondeterministicNode)selected).selected).virtualLoss) <= ((DeterministicNode)c).virtualLoss)
                                    {
                                        selected = c;
                                    }
                                }
                            ...
                            {
                                if (((DeterministicNode)selected).virtualLoss<=((DeterministicNode)c).virtualLoss)
                                {
                                    selected = c;
                                }
                            }
